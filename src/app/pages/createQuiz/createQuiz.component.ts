...
export class CreateQuizComponent{
  ...
  difficulties = [{"id": "easy", "name": "Easy"}, {"id": "medium", "name": "Medium"},{"id": "hard", "name": "Hard"}];
  types = [{"id": "multiple", "name": "Multiple Choice"}, {"id": "boolean", "name": "True/False"}];
    ...
    this.quizService.fetchQuestions().subscribe(
      (response: any) => {
        ...
        this.router.navigate(['/quiz/page'], { 
          state: { quizData: response, quizName: data.quizName }
        });
      },
      (error) => {
